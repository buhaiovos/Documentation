...
<html>
<head>
    <title>Освітньо-кваліфікаційні рівні</title>
    <!-- jTable Metro styles. -->
    ...
    <script src="js/Qualification.js" type="text/javascript" charset="UTF-8"></script>
...
<body>
    ...
    <div style="text-align: center;">
        <div id="QualificationTableContainer"></div>
    </div>
</body>
</html>
